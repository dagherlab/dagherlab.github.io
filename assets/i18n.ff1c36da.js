 ...
 */ const ie = typeof window != "undefined",
  Bt = typeof Symbol == "function" && typeof Symbol.toStringTag == "symbol",
  j = (e) => (Bt ? Symbol(e) : e),
  Kt = (e, t, n) => Xt({ l: e, k: t, s: n }),
  Xt = (e) =>
    JSON.stringify(e)
      .replace(/\u2028/g, "\\u2028")
      .replace(/\u2029/g, "\\u2029")
      .replace(/\u0027/g, "\\u0027"),
  S = (e) => typeof e == "number" && isFinite(e),
  Yt = (e) => Ne(e) === "[object Date]",
  ae = (e) => Ne(e) === "[object RegExp]",
  re = (e) => I(e) && Object.keys(e).length === 0;
function zt(e, t) {
...
const C = Array.isArray,
  ...
  Ne = (e) => ze.call(e),
  I = (e) => Ne(e) === "[object Object]",
  Qt = (e) =>
    e == null
      ? ""
      : C(e) || (I(e) && e.toString === ze)
...
function Qe(e, t, n = {}) {
  const { domain: a, messages: r, args: s } = n,
    l = e,
...
function dn(e = {}) {
  ...
  const E = (N) => (e.modifiers ? e.modifiers[N] : on),
    g = I(e.processor) && v(e.processor.normalize) ? e.processor.normalize : mn,
    b =
      I(e.processor) && v(e.processor.interpolate)
    ...
    F = {
      ...
      linked: (N, ...p) => {
        ...
        p.length === 1
          ? y(R)
            ? ((A = R.modifier || A), (f = R.type || f))
            : _(R) && (A = R || A)
          : p.length === 2 && (_(R) && (A = R || A), _(L) && (f = L || f));
        let M = d(N)(F);
...
function Tn(e, t, n) {
  return [
    ...new Set([n, ...(C(t) ? t : y(t) ? Object.keys(t) : _(t) ? [t] : [n])]),
  ];
}
function qe(e, t, n) {
  const a = _(n) ? n : Te,
  ...
  if (!s) {
    ...
    let l = [n];
    for (; C(l); ) l = Re(s, l, t);
    const i = C(t) || !I(t) ? t : t.default ? t.default : null;
...
const On = "9.2.2",
  ...
  Te = "en-US",
  De = "",
  Se = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function pn() {
  return {
    upper: (e, t) =>
      t === "text" && _(e)
        ? e.toUpperCase()
        : t === "vnode" && y(e) && "__v_isVNode" in e
...
let ve = 0;
function hn(e = {}) {
  const t = _(e.version) ? e.version : On,
    ...
    a =
      ...
      e.fallbackLocale === !1
        ? e.fallbackLocale
        : n,
    r = I(e.messages) ? e.messages : { [n]: {} },
    s = I(e.datetimeFormats) ? e.datetimeFormats : { [n]: {} },
    l = I(e.numberFormats) ? e.numberFormats : { [n]: {} },
    i = w({}, e.modifiers || {}, pn()),
    c = e.pluralRules || {},
  ...
  return (
    (V.datetimeFormats = s),
    (V.numberFormats = l),
    (V.__datetimeFormatters = X),
    (V.__numberFormatters = Y),
    V
  );
}
...
function ke(e, ...t) {
  ...
  g && Cn(m);
  let [N, p, R] = b ? [c, F, i[F] || {}] : nt(e, c, F, l, E, d),
    L = N,
    f = c;
  if (
    (!b && !(_(L) || $(L)) && O && ((L = T), (f = L)),
...
function Cn(e) {
  C(e.list)
    ? (e.list = e.list.map((t) => (_(t) ? Ae(t) : t)))
    : y(e.named) &&
...
function nt(e, t, n, a, r, s) {
  const { messages: l, onWarn: i, messageResolver: c, localeFallbacker: m } = e,
    d = m(e, a, n);
  let E = {},
    g,
    b = null;
...
function ue(...e) {
  ...
  return (
    S(n)
      ...
      ? (r.named = n)
      : C(n) && (r.list = n),
    S(a) ? (r.plural = a) : _(a) ? (r.default = a) : I(a) && w(r, a),
    [s, r]
  );
}
...
function Sn(e, t, n, a) {
  const {
    ...
    g = {
      ...
      messages: (b) => {
        let T = l(n, b);
        if (T == null && d) {
          const [, , O] = nt(d, b, t, i, c, m);
          T = l(O, b);
        }
        if (_(T)) {
          let O = !1;
          const N = at(e, b, t, T, b, () => {
            O = !0;
          });
          return O ? Me : N;
        } else return $(T) ? T : Me;
  ...
  return (
    ...
    S(a.plural) && (g.pluralIndex = a.plural),
    g
  );
}
function Pe(e, ...t) {
  ...
  for (
    let A = 0;
    A < O.length && ((N = O[A]), (F = n[N] || {}), (p = F[c]), !I(p));
    A++
  )
    Ie(e, c, N, g, R);
  if (!I(p) || !_(N)) return a ? le : c;
  let L = `${N}__${c}`;
  re(E) || (L = `${L}__${JSON.stringify(E)}`);
  let f = i.get(L);
  return (
    f || ((f = new Intl.DateTimeFormat(N, w({}, p, E))), i.set(L, f)),
    b ? f.formatToParts(m) : f.format(m)
  );
}
const rt = [
  "localeMatcher",
...
function me(...e) {
  ...
  else throw K(B.INVALID_ARGUMENT);
  return (
    _(n)
      ? (s.key = n)
      : I(n) &&
...
function Ue(e, ...t) {
  ...
  let f = i.get(L);
  return (
    f || ((f = new Intl.NumberFormat(N, w({}, p, E))), i.set(L, f)),
    b ? f.formatToParts(m) : f.format(m)
  );
}
const lt = [
...
const _e = j("__transrateVNode"),
  ge = j("__datetimeParts"),
  de = j("__numberParts"),
  Mn = j("__setPluralRules");
j("__intlifyMeta");
const kn = j("__injectWithOption");
function Ee(e) {
  if (!y(e)) return e;
  for (const t in e)
    if (!!be(e, t))
      if (!t.includes(".")) y(e[t]) && Ee(e[t]);
      else {
        const n = t.split("."),
          a = n.length - 1;
        let r = e;
        for (let s = 0; s < a; s++) n[s] in r || (r[n[s]] = {}), (r = r[n[s]]);
        (r[n[a]] = e[t]), delete e[t], y(r[n[a]]) && Ee(r[n[a]]);
      }
  return e;
}
function ot(e, t) {
  const { messages: n, __i18n: a, messageResolver: r, flatJson: s } = t,
    l = I(n) ? n : C(a) ? {} : { [e]: {} };
  if (
    (C(a) &&
      a.forEach((i) => {
        if ("locale" in i && "resource" in i) {
          const { locale: c, resource: m } = i;
          c ? ((l[c] = l[c] || {}), ee(m, l[c])) : ee(m, l);
        } else _(i) && ee(JSON.parse(i), l);
      }),
    r == null && s)
  )
    for (const i in l) be(l, i) && Ee(l[i]);
  return l;
}
const ne = (e) => !y(e) || C(e);
function ee(e, t) {
...
function wn(e, t, n) {
  let a = y(t.messages) ? t.messages : {};
  "__i18nGlobal" in n &&
    (a = ot(e.locale.value, { messages: a, __i18n: n.__i18nGlobal }));
...
function Ve(e) {
  return Gt($t, null, e, 0);
}
let xe = 0;
function je(e) {
  return (t, n, a, r) => e(n, a, Ye() || void 0, r);
}
function ct(e = {}, t) {
  const { __root: n } = e,
    a = n === void 0;
  let r = h(e.inheritLocale) ? e.inheritLocale : !0;
  const s = Q(n && r ? n.locale.value : _(e.locale) ? e.locale : Te),
    l = Q(
      n && r
    ...
    i = Q(ot(s.value, e)),
    c = Q(I(e.datetimeFormats) ? e.datetimeFormats : { [s.value]: {} }),
    m = Q(I(e.numberFormats) ? e.numberFormats : { [s.value]: {} });
  let d = n
      ? n.missingWarn
      : h(e.missingWarn) || ae(e.missingWarn)
      ? e.missingWarn
      : !0,
    E = n
      ? n.fallbackWarn
      : h(e.fallbackWarn) || ae(e.fallbackWarn)
      ? e.fallbackWarn
      : !0,
    ...
    p = !!e.escapeParameter;
  const R = n ? n.modifiers : I(e.modifiers) ? e.modifiers : {};
  ...
  (f = (() => {
    ...
    return (
      (o.datetimeFormats = c.value),
      (o.numberFormats = m.value),
      (o.__datetimeFormatters = I(f) ? f.__datetimeFormatters : void 0),
      (o.__numberFormatters = I(f) ? f.__numberFormatters : void 0),
      hn(o)
    );
  })()),
    Z(f, s.value, l.value);
  ...
  function ye(...o) {
    return H(
      (u) => Reflect.apply(ke, null, [u, ...o]),
      () => ue(...o),
      "translate",
      (u) => Reflect.apply(u.t, u, [...o]),
      (u) => u,
      (u) => _(u)
    );
  }
  function dt(...o) {
    ...
    return ye(u, x, w({ resolvedMessage: !0 }, k || {}));
  }
  function Et(...o) {
    return H(
      (u) => Reflect.apply(Pe, null, [u, ...o]),
      () => me(...o),
      "datetime format",
      (u) => Reflect.apply(u.d, u, [...o]),
      () => De,
      (u) => _(u)
    );
  }
  function bt(...o) {
    return H(
      (u) => Reflect.apply(Ue, null, [u, ...o]),
      () => fe(...o),
      "number format",
      (u) => Reflect.apply(u.n, u, [...o]),
      () => De,
      (u) => _(u)
    );
  }
  function Nt(o) {
    return o.map((u) => (_(u) || S(u) || h(u) ? Ve(String(u)) : u));
  }
  const Tt = { normalize: Nt, interpolate: (o) => o, type: "vnode" };
  function It(...o) {
    return H(
      (u) => {
        let x;
        const k = u;
        try {
          (k.processor = Tt), (x = Reflect.apply(ke, null, [k, ...o]));
        } finally {
          k.processor = null;
        }
        return x;
  ...
  function yt(o, u) {
    const x = _(u) ? u : s.value,
      k = Fe(x);
    return f.messageResolver(k, o) !== null;
  }
  function Ft(o) {
    let u = null;
    const x = qe(f, l.value, s.value);
    for (let k = 0; k < x.length; k++) {
      const se = i.value[x[k]] || {},
  ...
  function kt(o, u) {
    (m.value[o] = w(m.value[o] || {}, u)),
      (f.numberFormats = m.value),
      We(f, o, u);
  }
  xe++,
    n &&
  ...
  return (
    ...
    (D.d = Et),
    (D.n = bt),
    (D.getDateTimeFormat = Rt),
    (D.setDateTimeFormat = Dt),
    (D.mergeDateTimeFormat = St),
    (D.getNumberFormat = vt),
    (D.setNumberFormat = Mt),
    (D.mergeNumberFormat = kt),
    (D[kn] = e.__injectWithOption),
    (D[_e] = It),
    (D[ge] = Ot),
    (D[de] = Lt),
    D
...
const Ge = {
  ...
  setup(e, t) {
    const { slots: n, attrs: a } = t,
      r = e.i18n || Oe({ useScope: e.scope, __useComponent: !0 });
    return () => {
      const s = Object.keys(n).filter((E) => E !== "_"),
        l = {};
      e.locale && (l.locale = e.locale),
        e.plural !== void 0 && (l.plural = _(e.plural) ? +e.plural : e.plural);
      const i = Un(t, s),
  ...
  return () => {
    ...
    e.locale && (l.locale = e.locale),
      _(e.format)
        ? (l.key = e.format)
        : y(e.format) &&
          (_(e.format.key) && (l.key = e.format.key),
          (i = Object.keys(e.format).reduce(
            (g, b) => (n.includes(b) ? w({}, g, { [b]: e.format[b] }) : g),
            {}
          )));
    const c = a(e.value, l, i);
    let m = [l.key];
    C(c)
      ? (m = c.map((g, b) => {
          const T = r[g.type],
            O = T ? T({ [g.type]: g.value, index: b, parts: c }) : [g.value];
          return Wn(O) && (O[0].key = `${g.type}-${b}`), O;
        }))
      : _(c) && (m = [c]);
    const d = w({}, s),
...
const $e = {
    ...
    setup(e, t) {
      const n = e.i18n || Oe({ useScope: "parent", __useComponent: !0 });
      return ut(e, t, lt, (...a) => n[de](...a));
    },
  },
  He = {
    name: "i18n-d",
...
function xn(e) {
  const t = (l) => {
    const { instance: i, modifiers: c, value: m } = l;
    if (!i || !i.$) throw W(U.UNEXPECTED_ERROR);
    const d = Vn(e, i.$),
      E = Be(m);
    return [Reflect.apply(d.t, d, [...Ke(E)]), d];
  };
  return {
    created: (l, i) => {
      const [c, m] = t(i);
    ...
    beforeUpdate: (l, { value: i }) => {
      if (l.__composer) {
        const c = l.__composer,
          m = Be(i);
        l.textContent = Reflect.apply(c.t, c, [...Ke(m)]);
      }
    },
    getSSRProps: (l) => {
      const [i] = t(l);
...
function Ke(e) {
  const { path: t, locale: n, args: a, choice: r, plural: s } = e,
    l = {},
    i = a || {};
  return (
    _(n) && (l.locale = n),
...
function jn(e, t, ...n) {
  ...
  (h(a.globalInstall) ? a.globalInstall : !0) &&
    (e.component(r ? "i18n" : Ge.name, Ge),
    e.component($e.name, $e),
    e.component(He.name, He)),
    e.directive("t", xn(t));
}
const Gn = j("global-vue-i18n");
function $n(e = {}, t) {
  ...
  }
  {
    const E = {
      ...
      async install(g, ...b) {
        (g.__VUE_I18N_SYMBOL__ = i),
          g.provide(g.__VUE_I18N_SYMBOL__, E),
          n && qn(g, E.global),
          jn(g, E, ...b);
        const T = g.unmount;
        g.unmount = () => {
...
function Bn(e) {
  {
    const t = Vt(e.isCE ? Gn : e.appContext.app.__VUE_I18N_SYMBOL__);
...
function Yn(e, t, n = !1) {
  ...
  for (; s != null; ) {
    const l = e;
    if (
      (e.mode === "composition" && (a = l.__getInstance(s)),
      a != null || r === s)
    )
      break;
    s = s.parent;
...
Fn(sn);
An(qe);
var Zn = { failed: "Action failed", success: "Action was successful" },
  ea = { "en-US": Zn },
  ra = Ht(({ app: e }) => {
    const t = $n({ locale: "en-US", globalInjection: !0, messages: ea });
    e.use(t);
  });
